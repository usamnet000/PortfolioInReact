  ...
  return (
    <div>
      ...
      <p>
        ...
        <a
          href="https://twitter.com/usamnet00"
          target="_blank"
          class="main-module--link--2kFqk"
        >
          Twitter{" "}
          <svg
            aria-hidden="true"
        ...
        <a
          class="main-module--link--2kFqk"
          target="_blank"
          href="mailto:usamnet000@outlook.com"
          alt="Mail to usamnet000@outlook.com"
        >
          E-mail&nbsp;
          <svg
            aria-hidden="true"
      ...
      <div class="contact-module--icons--whoi2">
        <a
          href="https://twitter.com/usamnet00"
          target="_blank"
          class="contact-module--icon-link--2FOGD"
        >
          <svg
            aria-hidden="true"
            focusable="false"
        ...
        <a
          href="https://github.com/usamnet000"
          class="contact-module--icon-link--2FOGD"
          target="_blank"
        >
          <svg
        ...
        <a
          href="https://medium.com/@usamnet000"
          target="_blank"
          class="contact-module--icon-link--2FOGD"
        >
          <svg
            ...
            data-prefix="fab"
            data-icon="medium"
            class="svg-inline--fa fa-medium fa-w-14 "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
